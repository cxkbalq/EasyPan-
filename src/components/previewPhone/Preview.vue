...
<script setup>
import PreviewDoc from "@/components/previewPhone/PreviewDoc.vue";
import PreviewExcel from "@/components/previewPhone/PreviewExcel.vue";
import PreviewImage from "@/components/previewPhone/PreviewImage.vue";
import PreviewPdf from "@/components/previewPhone/PreviewPdf.vue";
import PreviewVideo from "@/components/previewPhone/PreviewVideo.vue";
import PreviewTxt from "@/components/previewPhone/PreviewTxt.vue";
import PreviewDownload from "@/components/previewPhone/PreviewDownload.vue";
import PreviewMusic from "@/components/previewPhone/PreviewMusic.vue";

import { ref, reactive, getCurrentInstance, nextTick, computed,defineEmits } from "vue";
